...
{
    public class SingleItemSelectViewCell : ViewCell
    {
        private readonly Label _title;
        private readonly Image _voidImage, _selectedImage;


        public static readonly BindableProperty TitleProperty = BindableProperty.Create(nameof(Title), typeof(string), typeof(SingleItemSelectViewCell), "Title");
        public string Title
        {
        ...
        public static readonly BindableProperty IsSelectedProperty = BindableProperty.Create(nameof(IsSelected), typeof(bool), typeof(SingleItemSelectViewCell), false);
        ...
        public SingleItemSelectViewCell()
        {
