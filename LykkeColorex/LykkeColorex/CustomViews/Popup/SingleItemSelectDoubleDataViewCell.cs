...
{
    public class SingleItemSelectDoubleDataViewCell : ViewCell
    {
        ...
        public static readonly BindableProperty TitleProperty = BindableProperty.Create(nameof(Title), typeof(string), typeof(SingleItemSelectDoubleDataViewCell), "Title");
        public string Title
        {
        ...
        public static readonly BindableProperty SecondaryTitleProperty = BindableProperty.Create(nameof(SecondaryTitle), typeof(string), typeof(SingleItemSelectDoubleDataViewCell), "SecondaryTitle");
        ...
        public static readonly BindableProperty IsSelectedProperty = BindableProperty.Create(nameof(IsSelected), typeof(bool), typeof(SingleItemSelectDoubleDataViewCell), false);
        ...
        public SingleItemSelectDoubleDataViewCell()
        {
            ...
            _selectedImage = new Image { Source = ImageSource.FromFile("popupSingleSelected"), Aspect = Aspect.AspectFit, IsVisible = IsSelected };
